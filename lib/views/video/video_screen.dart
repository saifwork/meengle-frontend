        ...
        return state.getOfferModel.data != null
            ? Stack(
                children: [
                  GestureDetector(
                    onTap: () {
                      final videoChatProvider = Provider.of<VideoChatProvider>(
                          context,
                          listen: false);
                      if (!videoChatProvider.videoViewShrink) {
                        videoChatProvider.changeViewState(
                            screenWidth, screenHeight);
                      }
                    },
                    child:
                        Consumer<VideoProvider>(builder: (context, value, _) {
                      return ClipRRect(
                      ...
                      return Positioned(
                        ...
                        child: GestureDetector(
                          ...
                          onPanEnd: (details) {
                            ...
                            } else if (videoChatProvider.position.dx >=
                                    centerX &&
                                videoChatProvider.position.dy < centerY) {
                              newOffset =
                                  Offset(screenWidth - widgetWidth - 10, 10);
                            } else if (videoChatProvider.position.dx <
                                    centerX &&
                                videoChatProvider.position.dy >= centerY) {
                              newOffset =
                                  Offset(10, screenHeight - widgetHeight - 10);
                            } else {
